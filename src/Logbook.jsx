...
function Logbook() {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                ...
                Swal.fire('Deleted!', 'Bye Bye.', 'success');
                fetchUsers();
            } catch (error) {
                Swal.fire('Error', error.response?.data?.message || 'An error occurred', 'error');
            }
    ...
    return (
        <>
            {/* Set Background in the Body or a Wrapper div */}
            <div style={{
                background: 'url(/nikebg.jpg) no-repeat center center fixed', 
                ...
                <Navbar bg="dark" variant="dark" expand="lg">
                    <Container>
                        <Navbar.Brand as={Link} to="/dashboard" className="fw-bold text-uppercase">
                            <i className="bi bi-book"></i> NIKE OUTLET
                        </Navbar.Brand>
                ...
                <Container>
                    <Row>
                        <Col>
                        <h1 className="text-center mt-4 text-white">EMPLOYEES</h1>
